using BA_Mobile.Core.Extension;
...
namespace BA_Mobile.Core
{
    ...
    public class DateTimeSecondConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            string result = string.Empty;
    ...
    public class MinutesToStringShortConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            var result = Math.Round((double)value, 0);
            return ((int)result).MinutesToStringShort();
        }
    ...
    public class NumberToHourConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value == null)
