    ...
    public class GroundOverlayLogic : DefaultGroundOverlayLogic<NativeGroundOverlay, GoogleMap>
    {
        ...
        protected override NativeGroundOverlay CreateNativeItem(GroundOverlay outerItem)
        {
            ...
            if (outerItem?.Icon?.Type == BitmapDescriptorType.View)
            {
                ...
                TransformMauiViewToAndroidBitmap(outerItem, overlay);
            }
            else
            {
        ...
        private async void TransformMauiViewToAndroidBitmap(GroundOverlay outerItem, NativeGroundOverlay nativeItem)
        {
